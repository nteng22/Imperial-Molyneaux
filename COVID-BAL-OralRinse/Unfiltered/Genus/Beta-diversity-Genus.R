...
ggplot(data = plot.data, aes(x = NMDS1, y = NMDS2)) + 
  ...
  labs(title = "NMDS by Genus of unfiltered taxa",
       subtitle = "PERMANOVA . ~ Sample-type p=0.001, .~Status p=0.02") +
...
ggsave("NMDS by Genus- unfiltered.pdf", width = 200, height = 200, units = c("mm"), dpi = 400)
