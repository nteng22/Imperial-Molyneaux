setwd("~/Documents/GitHub/Imperial-Molyneaux/COVID-BAL-OralRinse/Unfiltered/Genus/")
...
Palette <- c(Unknown = "darkseagreen1",
             Prevotella = "darkslategray2",
             Veillonella = "hotpink3",
             Leptotrichia = "goldenrod1",
             Streptococcus = "palegreen3",
             Actinomyces = "plum",
             Moryella = "tan2",
             Selenomonas = "darkseagreen4",
             Mogibacterium = "darkslategray4",
             Fusobacterium = "deeppink3",
             Others = "grey")
