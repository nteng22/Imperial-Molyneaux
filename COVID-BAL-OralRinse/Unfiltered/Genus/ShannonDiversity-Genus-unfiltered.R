...
species_metadata_filter <- species_metadata %>%
  filter(Status == "disease" |
           Status == "healthy")
wilcox.test(species_number ~ Status, data = species_metadata_filter) #p=0.25
wilcox.test(species_number ~ Sample.type, data = species_metadata_filter) #p=0.96
...
wilcox.test(shannon_diversity ~ Status, data = shannon_metadata_filter) # p=0.38
wilcox.test(shannon_diversity ~ Sample.type, data = shannon_metadata_filter) # p=0.53
