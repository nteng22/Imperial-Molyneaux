setwd(dir = "~/GitHub/Imperial-Molyneaux/COVID-BAL-OralRinse/Filtered data/")
...
##Select data
normalised_data <- read_csv("../Class-normalised-metadata.csv") %>%
...
genusPalette <- c( Bacilli = "cadetblue1",
                   Clostridia = "red",
                   Bacteroidia = "purple",
                   Actinobacteria = "blue",
                   Gammaproteobacteria = "green3",
                   Betaproteobacteria = "yellow",
                   Alphaproteobacteria = "red4",
                   Fusobacteriia = "green",
                   Coriobacteriia = "orange",
                   Flavobacteriia = "pink",
                   Others = "grey")
...
ggplot(sample_data_long,
  ...
  labs(title="Ten most abundant Classes",
       subtitle = "By proportional ASVs",
       x = "Sample ID",
...
ggsave("Ten most abundant Classes, 16S BAL vs. Oral.pdf", width = 150, height = 150, units = c("mm"), dpi = 300)
