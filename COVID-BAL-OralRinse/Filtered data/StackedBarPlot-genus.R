...
##Select data
normalised_data <- read_csv("../Genus-normalised-metadata.csv") %>%
...
genusPalette <- c( Streptococcus = "cadetblue1",
                   Prevotella = "red",
                   Veillonella = "purple",
                   Haemophilus = "blue",
                   Actinomyces = "green3",
...
ggsave("Ten most abundant genera, 16S BAL vs. Oral.pdf", width = 150, height = 150, units = c("mm"), dpi = 300)
