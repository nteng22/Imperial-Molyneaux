...
##Select data
normalised_data <- read_csv("../Phylum-normalised-metadata.csv") %>%
...
genusPalette <- c( Firmicutes = "cadetblue1",
                   Bacteroidetes = "red",
...
ggsave("Ten most abundant phyla, 16S BAL vs. Oral.pdf", width = 150, height = 150, units = c("mm"), dpi = 300)
