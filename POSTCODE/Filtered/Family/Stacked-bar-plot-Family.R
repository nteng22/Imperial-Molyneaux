...
##Select data
normalised_data <- read_csv("Family-normalised-unfiltered-metadata.csv") %>%
...
ggsave("Ten most abundant Family unfiltered.pdf", width = 300, height = 150, units = c("mm"), dpi = 300)
