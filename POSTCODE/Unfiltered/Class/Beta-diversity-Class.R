...
ggplot(data = plot.data, aes(x = NMDS1, y = NMDS2)) + 
  ...
  labs(title = "NMDS by Class of unfiltered taxa",
       subtitle = "PERMANOVA . ~ Sample-type p=0.007") +
...
ggsave("NMDS by Class- unfiltered.pdf", width = 200, height = 200, units = c("mm"), dpi = 400)
