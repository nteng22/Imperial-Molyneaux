...
metadata <- unique(metadata$`sample-id`)
...
normalised_data_filtered <- inner_join(metadata, normalised_data_filtered, by = "sample-id")
normalised_data_filtered <- normalised_data_filtered[!duplicated(normalised_data_filtered$`sample-id`), ]
