setwd("~/GitHub/Imperial-Molyneaux/IPF-progressive/Level1-IPF/Class/")
...
normalised_data <- read_csv("Class-normalised.csv") %>%
...
Palette <- c(Clostridia = "darkseagreen1",
             ...
             Gammaproteobacteria = "hotpink3",
             Bacilli = "goldenrod1",
             Betaproteobacteria = "palegreen3",
             Bacteroidia= "plum",
             Alphaproteobacteria = "tan2",
             Fusobacteriia = "darkseagreen4",
             Flavobacteriia = "darkslategray4",
...
ggsave("Ten most abundant Classes unfiltered.pdf", width = 400, height = 150, units = c("mm"), dpi = 300)
