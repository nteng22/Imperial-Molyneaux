...
setwd(dir = "~/GitHub/Imperial-Molyneaux/Healthy-controls//")
path <- "~/GitHub/Imperial-Molyneaux/Healthy-controls//"
list.files(path)
...
mapping = readxl::read_xlsx("HC-list.xlsx")
...
physeq
gplots::venn(list(mapping=rownames(mapping), sample_names(physeq)))
