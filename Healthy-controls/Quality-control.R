setwd("~/GitHub/Imperial-Molyneaux/Healthy-controls/")
setwd("~/Documents/GitHub/Imperial-Molyneaux/Healthy-controls/") # Personal device
...
ggplot(data=df, aes(x=Index, y=LibrarySize, colour = Diagnosis)) + geom_point() #somewhat rarecurve?
