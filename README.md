...
> [Metadata-PH.csv](https://github.com/nteng22/Imperial-Molyneaux/blob/main/COVID-BAL-OralRinse/Quality-check/metadata-PH.csv), is including Bavi's samples (pre-fixed with PH) but without mock samples (pre-fixed with MOC) flagged as *Sample-type == EXCLUDE*. <br>
...
> [Metadata.R](https://github.com/nteng22/Imperial-Molyneaux/blob/main/COVID-BAL-OralRinse/Quality-check/Metadata.R), separates the sampleID submitted for seqeuncing to the disease types, sample types and patientID. <br>
> [Contamination-Normalisation.R](https://github.com/nteng22/Imperial-Molyneaux/blob/main/COVID-BAL-OralRinse/Quality-check/Contamination-Normalisation.R), script to identify and remove contaminants from samples. This was based off of 'reagent controls'. Script also includes normalising reads resulting in relative abundancse. <br>
> [Metadata-to-reads.R](https://github.com/nteng22/Imperial-Molyneaux/blob/main/COVID-BAL-OralRinse/Quality-check/Metadata-to-reads.R), joins the metadata to relative abundances. 
